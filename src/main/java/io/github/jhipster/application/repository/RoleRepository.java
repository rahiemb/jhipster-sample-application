...
public interface RoleRepository extends JpaRepository<Role, Long> {
    ...
    @Query(value = "select distinct role from Role role left join fetch role.abilities",
    ...
    @Query("select role from Role role left join fetch role.abilities where role.id =:id")
