...
import { IComment, Comment, CommentContext } from 'app/shared/model/comment.model';
...
describe('Service Tests', () => {
    describe('Comment Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Comment(0, 'AAAAAAA', CommentContext.APPENDIX, 'AAAAAAA', currentDate, 'AAAAAAA', 'AAAAAAA');
        });
