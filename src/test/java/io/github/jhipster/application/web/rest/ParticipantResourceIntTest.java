...
public class ParticipantResourceIntTest {
    ...
    public void createParticipant() throws Exception {
        ...
        assertThat(testParticipant.getValue()).isEqualTo(DEFAULT_VALUE);
        assertThat(testParticipant.isEnabled()).isEqualTo(DEFAULT_ENABLED);
    }
    ...
    public void updateParticipant() throws Exception {
        ...
        Participant testParticipant = participantList.get(participantList.size() - 1);
        assertThat(testParticipant.getValue()).isEqualTo(UPDATED_VALUE);
        assertThat(testParticipant.isEnabled()).isEqualTo(UPDATED_ENABLED);
    }
